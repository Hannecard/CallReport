              ...
              <div class="row">
                <div class="col s12 m12 l6">
                  <div class="card-panel">
                    <h4 class="header2">Ajout catégorie</h4>
                    <div class="row">
                      <form class="col s12" enctype="multipart/form-data" method="POST" action="">
                        ...
                        <select name="parent_category">
                          <option   value="0" >Choisir une catégorie mère</option>
                          <?php


                          foreach ($cat_parent as $c) {
                          echo"<option  value=".$c->id.">".$c->lib."</option>";
                        ...
                        <div class="file-path-wrapper">
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                              <button class="btn cyan waves-effect waves-light right" type="submit" name="ajout">Ajouter
                ...
                <div class="col s12 m12 l6">
                  <div class="card-panel">
                    <h4 class="header2">Listes des catégories</h4>
                    <div class="row">
                    ...
                    <tr class="group"><td colspan="5">Catégories Principales</td></tr>


                    <?php
                    foreach ($listecat_parent as $c) {

                      echo"<tr>
                      <td><input type='checkbox' name='checked' value=".$c->id." id=".$c->id." /> <label for=".$c->id."></label></td>
                        <td>".$c->lib."</td>
                        <td>Aucun</td>
                    ...
                    <tr class="group"><td colspan="5">Catégories Secondaires </td></tr>
