...
<div id="main">
    ...
    <div class="wrapper">
        ...
        <div class="container">
            <div class="section" style="width:85%; margin: 0 auto;">
                <div class="row">

                <?php

                foreach ($infos_cat as $i) {
                 echo"

                 <div class='col s12 m3 grid' style='min-width: calc(330px + 1%);''>
                      <figure class='effect-romeo'>
                        <img src='images/gallary/17.jpg' alt='img17'/>
                        <figcaption>
                          <h2>".$i->libelle_categorie."<span></span></h2>
