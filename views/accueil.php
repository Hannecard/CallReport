...
<body>
  ...
  <div class="grey-text text-lighten-4 titre-page">
    <div>Hannecard</div>
      ...
      <li class='collection-item avatar'>
            ...
            <div class='collapsible-body'>
                <ul>
                    ...
                    <li><a href='#modalUpTodoPers' class='btn-floating pink darken-3 tooltipped modal-trigger btnuptodopers' data-position='bottom' data-delay='50' data-tooltip='Personnes Concernées'><i class='material-icons'>person_pin</i></a></li>
